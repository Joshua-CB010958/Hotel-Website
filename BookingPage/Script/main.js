...
bookNowBtn.addEventListener('click', function() {
  alert(`Your Reservation is confirmed ${nameInput.value}! and your Overall Cost of Room Booking is Rs${totOc.toFixed(2)}`);
});
...
bookAdventureBtn.addEventListener('click', function() {
  alert(`Thank you ${advName.value}, your adventure is successfully booked!`);
  location.reload();
});
